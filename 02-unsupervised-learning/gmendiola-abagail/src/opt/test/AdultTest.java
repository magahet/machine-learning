 ...
 * find optimal weights to a neural network that is classifying Adult as having either fewer 
...
public class AdultTest {
    private static Instance[] instancesTrain = initializeInstances("adult.train.csv");
    private static Instance[] instancesTest = initializeInstances("adult.test.csv");

    private static int inputLayer = 19, hiddenLayer = 5, outputLayer = 1, trainingIterations = 10000;
    ...
    private static Instance[] initializeInstances(String fileName) {
        ...
        double[][][] attributes = new double[1000][][];

        try {
            BufferedReader br = new BufferedReader(new FileReader(new File("src/opt/test/" + fileName)));
